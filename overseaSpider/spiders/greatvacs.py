...
site_name = 'greatvacs'  # 站名 如 'shopweareiconic'
domain_name = 'greatvacs.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://greatvacs.com'  # URL 前缀 如 'https://shopweareiconic.com'
