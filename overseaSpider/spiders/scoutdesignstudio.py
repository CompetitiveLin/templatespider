...
site_name = 'scoutdesignstudio'  # 站名 如 'shopweareiconic'
domain_name = 'scoutdesignstudio.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://scoutdesignstudio.com'  # URL 前缀 如 'https://shopweareiconic.com'
