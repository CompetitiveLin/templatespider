...
site_name = 'canningvale'  # 站名 如 'shopweareiconic'
domain_name = 'canningvale.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.canningvale.com/'  # URL 前缀 如 'https://shopweareiconic.com'
