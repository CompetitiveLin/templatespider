...
class ThecrossdesignSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.fashionphile.com/']
    ...
    def parse(self, response):
        """获取全部分类"""
        category_urls = response.xpath("//ul[contains(@class,'dropdown-menu')]/li/ul/li/a/@href").getall()
        category_urls.pop()
        category_urls.append('https://www.fashionphile.com/shop/new-arrivals')
        category_urls.append('https://www.fashionphile.com/shop/categories/watches')
