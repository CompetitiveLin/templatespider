...
site_name = 'heritagesportsart'  # 站名 如 'shopweareiconic'
domain_name = 'heritagesportsart.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://heritagesportsart.com'  # URL 前缀 如 'https://shopweareiconic.com'
