...
site_name = 'artaigallery'  # 站名 如 'shopweareiconic'
domain_name = 'artaigallery.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.artaigallery.com'  # URL 前缀 如 'https://shopweareiconic.com'
