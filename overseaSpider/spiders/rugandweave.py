...
site_name = 'rugandweave'  # 站名 如 'shopweareiconic'
domain_name = 'rugandweave.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.rugandweave.com'  # URL 前缀 如 'https://shopweareiconic.com'
