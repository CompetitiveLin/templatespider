...
site_name = 'beauteque'  # 站名 如 'shopweareiconic'
domain_name = 'beauteque.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://beauteque.com'  # URL 前缀 如 'https://shopweareiconic.com'
