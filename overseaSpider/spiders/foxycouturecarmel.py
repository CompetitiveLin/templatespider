...
site_name = 'foxycouturecarmel'  # 站名 如 'shopweareiconic'
domain_name = 'foxycouturecarmel.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://foxycouturecarmel.com'  # URL 前缀 如 'https://shopweareiconic.com'
