...
site_name = 'greengoddesssupply'  # 站名 如 'shopweareiconic'
domain_name = 'greengoddesssupply.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.greengoddesssupply.com'  # URL 前缀 如 'https://shopweareiconic.com'
