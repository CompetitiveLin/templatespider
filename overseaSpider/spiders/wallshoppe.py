...
site_name = 'wallshoppe'  # 站名 如 'shopweareiconic'
domain_name = 'wallshoppe.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.wallshoppe.com'  # URL 前缀 如 'https://shopweareiconic.com'
