...
site_name = 'zagonestudios'  # 站名 如 'shopweareiconic'
domain_name = 'zagonestudios.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://zagonestudios.com'  # URL 前缀 如 'https://shopweareiconic.com'
