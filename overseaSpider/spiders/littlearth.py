...
site_name = 'littlearth'  # 站名 如 'shopweareiconic'
domain_name = 'littlearth.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://littlearth.com'  # URL 前缀 如 'https://shopweareiconic.com'
