...
site_name = 'loomyhome'  # 站名 如 'shopweareiconic'
domain_name = 'loomyhome.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://loomyhome.com'  # URL 前缀 如 'https://shopweareiconic.com'
