...
website = 'guardian'
website_url = 'https://guardian.com.my/'
...
class ThecrossdesignSpider(scrapy.Spider):
    ...
    start_urls = ['https://guardian.com.my/']
    ...
    def parse(self, response):
        """获取全部分类"""
        category_urls = response.xpath("//div[contains(@class,'topNavItem-topMenuName-1YC')]/../@href").getall()
        category_urls = category_urls.pop()
        print(category_urls)
