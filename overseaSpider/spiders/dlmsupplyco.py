...
site_name = 'dlmsupplyco'  # 站名 如 'shopweareiconic'
domain_name = 'dlmsupplyco.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.dlmsupplyco.com'  # URL 前缀 如 'https://shopweareiconic.com'
