...
site_name = 'bricksandminifigsportland'  # 站名 如 'shopweareiconic'
domain_name = 'bricksandminifigsportland.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://bricksandminifigsportland.com'  # URL 前缀 如 'https://shopweareiconic.com'
