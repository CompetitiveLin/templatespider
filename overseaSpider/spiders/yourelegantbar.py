...
site_name = 'yourelegantbar'  # 站名 如 'shopweareiconic'
domain_name = 'yourelegantbar.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://yourelegantbar.com'  # URL 前缀 如 'https://shopweareiconic.com'
