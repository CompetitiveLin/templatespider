...
site_name = 'sammyandnat'  # 站名 如 'shopweareiconic'
domain_name = 'sammyandnat.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://sammyandnat.com'  # URL 前缀 如 'https://shopweareiconic.com'
