...
site_name = 'cololight'  # 站名 如 'shopweareiconic'
domain_name = 'cololight.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://cololight.com'  # URL 前缀 如 'https://shopweareiconic.com'
