...
class ThecrossdesignSpider(scrapy.Spider):
    name = website
    allowed_domains = ['tlji.com']
    start_urls = ['https://tlji.com/']
    ...
    def parse(self, response):
        """获取全部分类"""
        category_urls = ['https://tlji.com/15-puzzles',
                         'https://tlji.com/16-games',
                         'https://tlji.com/17-electronic-learning',
                         'https://tlji.com/18-active-play',
                         'https://tlji.com/19-constructive-play']
        for category_url in category_urls:
            yield scrapy.Request(url=category_url, callback=self.parse_list)

    def parse_list(self, response):
        """商品列表页"""
        detail_url_list = response.xpath("//div[@class='img_block']/a/@href").getall()
    ...
    def parse_detail(self, response):
        ...
        description = response.xpath("//div[@itemprop='description' and @class='product-desc' and @id]").getall()
        items["description"] = self.filter_text(self.filter_html_label(''.join(description)))
        items["source"] = website

        images_list = response.xpath("//div[@class='thumb-container']/img/@data-image-large-src").getall()
