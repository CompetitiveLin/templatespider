...
site_name = 'sanlorenzohawaii'  # 站名 如 'shopweareiconic'
domain_name = 'sanlorenzohawaii.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://sanlorenzohawaii.com/'  # URL 前缀 如 'https://shopweareiconic.com'
