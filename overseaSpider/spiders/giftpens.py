...
site_name = 'giftpens'  # 站名 如 'shopweareiconic'
domain_name = 'giftpens.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.giftpens.com'  # URL 前缀 如 'https://shopweareiconic.com'
