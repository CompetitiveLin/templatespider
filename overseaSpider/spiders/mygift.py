...
site_name = 'mygift'  # 站名 如 'shopweareiconic'
domain_name = 'mygift.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.mygift.com'  # URL 前缀 如 'https://shopweareiconic.com'
