...
site_name = 'skybygramophone'  # 站名 如 'shopweareiconic'
domain_name = 'skybygramophone.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://skybygramophone.com'  # URL 前缀 如 'https://shopweareiconic.com'
