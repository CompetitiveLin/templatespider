...
site_name = 'hausful'  # 站名 如 'shopweareiconic'
domain_name = 'hausful.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://hausful.com'  # URL 前缀 如 'https://shopweareiconic.com'
