...
site_name = 'soccerwearhouse'  # 站名 如 'shopweareiconic'
domain_name = 'soccerwearhouse.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://soccerwearhouse.com'  # URL 前缀 如 'https://shopweareiconic.com'
