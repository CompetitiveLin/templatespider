...
# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：templatespider -> impactapologetics
@IDE    ：PyCharm
@Author ：Mr. Tutou
...
class ThecrossdesignSpider(scrapy.Spider):
    name = website
    allowed_domains = ['impactapologetics.com']
    start_urls = ['https://www.impactapologetics.com/']
    ...
    def parse(self, response):
        """获取全部分类"""
        category_urls = ['https://impactapologetics.com/books-1/','https://impactapologetics.com/audio/',\
                         'https://impactapologetics.com/video/','https://impactapologetics.com/fun-stuff/','https://impactapologetics.com/bible-studies-curriculum/']
    ...
    def parse_detail(self, response):
        ...
        items["original_price"] = response.xpath('//div[@class="productView-price"]//span[@class="price price--rrp"]/text()').get()
        items["current_price"] = response.xpath('//div[@class="productView-price"]//span[@class="price price--withoutTax price--main"]/text()').get()

        items["original_price"] = self.price_fliter(items["original_price"])
        items["current_price"] = self.price_fliter(items["current_price"])

        if items["original_price"] == '':
        ...
        items["source"] = 'impactapologetics.com'

        # attr1_list = response.xpath('//tbody[@class="table-tbody"]/tr/td[1]/text()').getall()
        # attr2_list = response.xpath('//tbody[@class="table-tbody"]/tr/td[2]/text()').getall()
        # attribute = []
