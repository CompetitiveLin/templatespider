...
# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：templatespider -> 707motoring
@IDE    ：PyCharm
@Author ：Mr. Tutou
...
class ThecrossdesignSpider(scrapy.Spider):
    name = website
    allowed_domains = ['707motoring.com']
    start_urls = ['https://707motoring.com/']
    ...
    def parse(self, response):
        """获取全部分类"""
        category_urls = ['https://707motoring.com/exterior/','https://707motoring.com/interior/','https://707motoring.com/lighting/','https://707motoring.com/performance/','https://707motoring.com/pillar-posts/']
    ...
    def parse_detail(self, response):
        ...
        items["current_price"] = self.price_fliter(response.xpath('//span[@class="price price--withoutTax"]/text()').get())
        price = response.xpath('//div[@class="productView-price"]//span[@class="price price--rrp"]/text()').get().strip()
        ...
        cat_list = response.xpath('//a[@class="breadcrumb-label"]/span/text()').getall()
        ...
        if not opt_name:
            ...
            for attrs in attrs_list:
                ...
                for attr in attrs.items():
                    ...
                    elif attr[0] == 'Choose your color' or 'Finish/Color':
