...
site_name = 'zzdriggs'  # 站名 如 'shopweareiconic'
domain_name = 'zzdriggs.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://zzdriggs.com'  # URL 前缀 如 'https://shopweareiconic.com'
