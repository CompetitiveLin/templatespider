...
site_name = 'mododoc'  # 站名 如 'shopweareiconic'
domain_name = 'mododoc.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://mododoc.com'  # URL 前缀 如 'https://shopweareiconic.com'
