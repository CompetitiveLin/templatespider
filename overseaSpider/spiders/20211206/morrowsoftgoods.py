...
site_name = 'morrowsoftgoods'  # 站名 如 'shopweareiconic'
domain_name = 'morrowsoftgoods.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://morrowsoftgoods.com'  # URL 前缀 如 'https://shopweareiconic.com'
