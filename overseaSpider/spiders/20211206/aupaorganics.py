...
website = 'aupaorganics'
website_url = 'https://www.aupaorganics.com'
...
class ThecrossdesignSpider(scrapy.Spider):
    name = website
    allowed_domains = ['aupaorganics.com']
    start_urls = ['https://www.aupaorganics.com/']
    ...
    def parse(self, response):
        """获取全部分类"""
        category_urls = ['https://www.aupaorganics.com/3-ropa-de-bebe-ninos',
                         'https://www.aupaorganics.com/6-juguetes-de-madera',
                         'https://www.aupaorganics.com/4-cosmetica-natural',
                         'https://www.aupaorganics.com/5-accesorios-ecologicos-alimentacion-bebe',
                         'https://www.aupaorganics.com/7-casa',
                         'https://www.aupaorganics.com/105-vale-regalo']
    ...
    def parse_list(self, response):
        ...
        # detail_url_list = ['https://www.aupaorganics.com/ropa-de-bebe-ninos/4620-pantalones-stardust-organic-zoo.html',
        #                    'https://www.aupaorganics.com/ropa-de-bebe-ninos/4403-gorro-violet-golden-caramel-liewood.html']

        for detail_url in detail_url_list:
            yield scrapy.Request(url=detail_url, callback=self.parse_detail)
        next_page_url = response.xpath("//li[@id='pagination_next_bottom']/a/@href").get()
        if next_page_url:
    ...
    def parse_detail(self, response):
        ...
        t1 = response.xpath("//table[@class='table-data-sheet']//tr/td[1]/text()").getall()
        t2 = response.xpath("//table[@class='table-data-sheet']//tr/td[2]/text()").getall()
        attr_list = []
        for t in range(len(t1)):
            t1[t]=self.filter_text(t1[t])
            t2[t] = self.filter_text(t2[t])
            attr_list.append(t1[t]+":"+t2[t])
        items["attributes"] = attr_list
        images_list = response.xpath("//ul[@id='thumbs_list_frame']/li/a/@href").getall()
        items["images"] = images_list
        v_json_str = re.search(r"addProductDetailView\((.*?)\);",response.text).group(1)
