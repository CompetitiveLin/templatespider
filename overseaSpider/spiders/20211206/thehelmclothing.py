...
site_name = 'thehelmclothing'  # 站名 如 'shopweareiconic'
domain_name = 'thehelmclothing.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://thehelmclothing.com'  # URL 前缀 如 'https://shopweareiconic.com'
