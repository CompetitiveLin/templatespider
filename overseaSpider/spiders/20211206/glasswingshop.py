...
site_name = 'glasswingshop'  # 站名 如 'shopweareiconic'
domain_name = 'glasswingshop.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://glasswingshop.com'  # URL 前缀 如 'https://shopweareiconic.com'
