...
site_name = 'judaicaplaza'  # 站名 如 'shopweareiconic'
domain_name = 'judaicaplaza.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://judaicaplaza.com'  # URL 前缀 如 'https://shopweareiconic.com'
