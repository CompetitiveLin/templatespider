...
class ThecrossdesignSpider(scrapy.Spider):
    name = website
    allowed_domains = ['audew.com']
    start_urls = ['https://www.audew.com/']
    ...
    def parse(self, response):
        """获取全部分类"""
        category_urls = response.xpath("//div[@class='pc-container m-fixAuto-y']/div[1]//div[@class='menuItem']/p/a/@href").getall()
