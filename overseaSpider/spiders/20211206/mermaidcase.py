...
site_name = 'mermaidcase'  # 站名 如 'shopweareiconic'
domain_name = 'mermaidcase.co'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://mermaidcase.co'  # URL 前缀 如 'https://shopweareiconic.com'
