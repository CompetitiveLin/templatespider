...
site_name = 'okoahome'  # 站名 如 'shopweareiconic'
domain_name = 'okoahome.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.okoahome.com'  # URL 前缀 如 'https://shopweareiconic.com'
