...
site_name = 'boisetcuir'  # 站名 如 'shopweareiconic'
domain_name = 'boisetcuir.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.boisetcuir.com'  # URL 前缀 如 'https://shopweareiconic.com'
