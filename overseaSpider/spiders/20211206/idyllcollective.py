...
site_name = 'idyllcollective'  # 站名 如 'shopweareiconic'
domain_name = 'idyllcollective.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.idyllcollective.com'  # URL 前缀 如 'https://shopweareiconic.com'
