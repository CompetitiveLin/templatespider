...
site_name = 'zeromariacornejo'  # 站名 如 'shopweareiconic'
domain_name = 'zeromariacornejo.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://zeromariacornejo.com'  # URL 前缀 如 'https://shopweareiconic.com'
