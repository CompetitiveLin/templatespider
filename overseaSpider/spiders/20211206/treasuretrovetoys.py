...
class ThecrossdesignSpider(scrapy.Spider):
    name = website
    allowed_domains = ['treasuretrovetoys.com']
    start_urls = ['https://treasuretrovetoys.com/']
    ...
    def parse(self, response):
        """获取全部分类"""
        category_urls = response.xpath("//ul[@class='navPages-list']/li[@class='navPages-item'][position()<6]/a/@href").getall()
    ...
    def parse_detail(self, response):
        ...
        price_now = response.xpath("//div[@class='productView-price']//span[@class='price price--withoutTax']/text()").get()
