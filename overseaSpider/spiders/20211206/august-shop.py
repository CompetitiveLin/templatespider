...
site_name = 'august-shop'  # 站名 如 'shopweareiconic'
domain_name = 'august-shop.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://august-shop.com'  # URL 前缀 如 'https://shopweareiconic.com'
