...
site_name = 'bongoutlet'  # 站名 如 'shopweareiconic'
domain_name = 'bongoutlet.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.bongoutlet.com'  # URL 前缀 如 'https://shopweareiconic.com'
