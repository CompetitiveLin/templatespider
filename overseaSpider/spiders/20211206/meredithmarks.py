...
site_name = 'meredithmarks'  # 站名 如 'shopweareiconic'
domain_name = 'meredithmarks.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://meredithmarks.com'  # URL 前缀 如 'https://shopweareiconic.com'
