...
site_name = 'bigdropnyc'  # 站名 如 'shopweareiconic'
domain_name = 'bigdropnyc.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://bigdropnyc.com'  # URL 前缀 如 'https://shopweareiconic.com'
