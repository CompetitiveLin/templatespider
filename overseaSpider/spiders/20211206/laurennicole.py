...
site_name = 'laurennicole'  # 站名 如 'shopweareiconic'
domain_name = 'laurennicole.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.laurennicole.com'  # URL 前缀 如 'https://shopweareiconic.com'
