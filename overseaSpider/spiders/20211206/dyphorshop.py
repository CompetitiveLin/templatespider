...
site_name = 'dyphorshop'  # 站名 如 'shopweareiconic'
domain_name = 'dyphorshop.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://dyphorshop.com'  # URL 前缀 如 'https://shopweareiconic.com'
