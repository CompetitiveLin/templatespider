...
site_name = 'dancewearcorner'  # 站名 如 'shopweareiconic'
domain_name = 'dancewearcorner.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://dancewearcorner.com'  # URL 前缀 如 'https://shopweareiconic.com'
