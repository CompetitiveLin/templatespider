...
site_name = 'puffingbird'  # 站名 如 'shopweareiconic'
domain_name = 'puffingbird.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://puffingbird.com'  # URL 前缀 如 'https://shopweareiconic.com'
