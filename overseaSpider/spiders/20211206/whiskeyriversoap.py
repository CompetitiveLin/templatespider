...
site_name = 'whiskeyriversoap'  # 站名 如 'shopweareiconic'
domain_name = 'whiskeyriversoap.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://whiskeyriversoap.com'  # URL 前缀 如 'https://shopweareiconic.com'
