...
site_name = 'caseelegance'  # 站名 如 'shopweareiconic'
domain_name = 'caseelegance.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://caseelegance.com'  # URL 前缀 如 'https://shopweareiconic.com'
