...
site_name = 'propizzaovens'  # 站名 如 'shopweareiconic'
domain_name = 'propizzaovens.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://propizzaovens.com'  # URL 前缀 如 'https://shopweareiconic.com'
