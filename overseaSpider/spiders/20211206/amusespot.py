...
site_name = 'amusespot'  # 站名 如 'shopweareiconic'
domain_name = 'amusespot.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://amusespot.com'  # URL 前缀 如 'https://shopweareiconic.com'
