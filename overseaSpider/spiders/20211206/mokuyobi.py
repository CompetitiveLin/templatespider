...
site_name = 'mokuyobi'  # 站名 如 'shopweareiconic'
domain_name = 'mokuyobi.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://mokuyobi.com'  # URL 前缀 如 'https://shopweareiconic.com'
