...
site_name = 'txhumor'  # 站名 如 'shopweareiconic'
domain_name = 'txhumor.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://txhumor.com'  # URL 前缀 如 'https://shopweareiconic.com'
