...
site_name = 'hawkinswoodshop'  # 站名 如 'shopweareiconic'
domain_name = 'hawkinswoodshop.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://hawkinswoodshop.com'  # URL 前缀 如 'https://shopweareiconic.com'
