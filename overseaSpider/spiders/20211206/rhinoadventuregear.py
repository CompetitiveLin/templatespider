...
site_name = 'rhinoadventuregear'  # 站名 如 'shopweareiconic'
domain_name = 'rhinoadventuregear.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.rhinoadventuregear.com'  # URL 前缀 如 'https://shopweareiconic.com'
